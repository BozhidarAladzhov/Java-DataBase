...
CREATE DATABASE IF NOT EXISTS `soft_uni_data_agregation` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `soft_uni_data_agregation`;
...
SELECT e.department_id, ( SELECT DISTINCT salary FROM employees
